...
The AQP refactor consolidates every operator surface into the unified `aqp_client` container (see [`agentic_quant_platform/docs/architecture/decisions/002-single-container-client.md`](../../../agentic_quant_platform/docs/architecture/decisions/002-single-container-client.md)):
...
| ------------------------ | ------------------------------------------ | ----------- |
| `/nodes`                 | `frontend/src/routes/control-plane/...`    | Pending     |
| `/deployments`           | `frontend/src/routes/control-plane/deployments/page.tsx` | Mature |
| `/services`              | `frontend/src/routes/control-plane/...`    | Pending     |
...
- **No new API integrations here.** The control plane's `/manage/*` endpoints are reachable from the AQP frontend via the `aqp_client` reverse proxy at `/manage/...`.
